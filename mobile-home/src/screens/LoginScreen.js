      ...
      >
        ...
        <View style={styles.header}>
          ...
          <View style={styles.logoBox}>
            <MaterialIcons name="account-balance" size={36} color={colors.onPrimary} />
          </View>
        ...
        <GlassCard style={styles.card}>
          <View style={styles.cardInner}>
            ...
            <View style={styles.fieldGroup}>
              <View style={styles.passwordLabelRow}>
                ...
                <TouchableOpacity activeOpacity={0.7}>
                  <Text style={[styles.forgotText, { fontFamily: bodySemiBold }]}>
                    Quên mật khẩu?
                  </Text>
                </TouchableOpacity>
              </View>
            ...
            <View style={styles.actionsGroup}>
              <TouchableOpacity activeOpacity={0.88} style={styles.loginBtnWrapper}>
                <LinearGradient
                ...
                >
                  <Text style={[styles.loginBtnText, { fontFamily: headlineBold }]}>
                    Đăng nhập
                  </Text>
                </LinearGradient>
              </TouchableOpacity>
              ...
              <View style={styles.dividerRow}>
                ...
                <Text style={[styles.dividerText, { fontFamily: bodySemiBold }]}>hoặc</Text>
                <View style={styles.dividerLine} />
              </View>
              ...
              <View style={styles.biometricRow}>
                <BiometricButton
                  iconName={Platform.OS === 'ios' ? 'face-retouching-natural' : 'face'}
                  label="FaceID"
        ...
        <TouchableOpacity style={styles.openAccountBtn} activeOpacity={0.8}>
          ...
          <Text style={[styles.openAccountText, { fontFamily: headlineBold }]}>
            Mở tài khoản mới
          </Text>
        </TouchableOpacity>
        ...
        <View style={styles.quickLinks}>
          {[
            ...
            <TouchableOpacity key={label} style={styles.quickLinkItem} activeOpacity={0.7}>
              <MaterialIcons name={icon} size={22} color={colors.onSurfaceVariant} />
              <Text style={[styles.quickLinkLabel, { fontFamily: bodySemiBold }]}>
                {label}
              </Text>
            </TouchableOpacity>
          ))}
        ...
        <View style={styles.footer}>
          <Text style={[styles.footerText, { fontFamily: bodyRegular }]}>
            © 2024 The Sovereign Trust. Bản quyền thuộc về Ngân hàng Heritage Digital.{'\n'}
